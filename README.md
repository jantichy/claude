...
Nad projektem, ve kterém pozná svůj vlastní otisk – blok metadat v `CLAUDE.md` –, se chová jinak: přepne se do **revize** a místo otázek projde celý projekt proti tomu, jak standardy vypadají dnes – sekce v `CLAUDE.md`, deklarace a kontrakty, umístění a vnitřní tvar dokumentace, odkazy na skilly a doménové znalosti, které se mezitím mohly přejmenovat. Řeší to jinak nepříjemnou vlastnost celé téhle vrstvy: konfigurace se vyvíjí dál, ale projekty založené za starého nastavení v něm zůstanou stát a samy o tom neřeknou. Tohle je způsob, jak je dorovnat jedním zavoláním. Projekt bez otisku – ať v něm skill nikdy neběžel, nebo ho nastavovala starší verze – jde nejdřív průvodcem a revize na něj přijde na konci.
