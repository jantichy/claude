...
Nejdřív zjistí, jestli to má kdo chtít: kdo ten problém má, jak ho dnes řeší, co ho to stojí a čím je doložené, že ho chce řešit jinak – a skončí to verdiktem o dvou hodnotách, ne dojmem. Nedoložená poptávka je nejdražší způsob, jak celá práce selže, protože se projeví až jako hotový produkt, který nikdo nepoužívá, a tohle je jediné místo, kde ta otázka zazní. Pak teprve zjistí, do jakého světa produkt vstupuje: kdo to už dělá, co to umí a za kolik, čím to lidé řeší dneska, když na to nemají nástroj, a na co si u stávajících řešení stěžují. Z toho vytřídí, co produkt musí umět, aby ho někdo vzal vážně, a čím se dá odlišit – ale jen tak, aby to šlo doložit. K tomu sepíše registr rizik, ve kterém má každá položka povinné pole *co se kvůli tomu v produktu změní*. Stojí před zadáním schválně: analýza, která dorazí až po schválené specifikaci, se buď ignoruje, nebo znamená přepis všeho.
