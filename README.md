...
**Krok osy mezi zadáním a plánem** – protože jinak návrh neměří nikdo: `/review` ověřuje kód proti specifikaci, ale samotnou specifikaci nikdo proti ničemu, takže vada v ní projde celou osou jako korektní. U drobné změny se přeskočí, u nového systému ne. Nezávislý posudek dokumentu, který jsem psal s Claudem – pozicování, cenotvorby, datového modelu. Pošle na něj agenty, kteří **nemají z naší session žádný kontext** a čtou jenom soubory; každý s jiným úhlem. Katalog úhlů je rozdělený na **metody** (jak se dívat – vnitřní rozpory, nevyslovené předpoklady, pre-mortem, zneužití, co je nevratné) a **domény** (na co se dívat – ekonomika provozu, osobní údaje, data, cílová skupina), protože metoda bez domény je slepá a doména bez metody sbírá povrch; u každého úhlu je napsaný **spouštěč** – vlastnost dokumentu, která ho vyvolá („slibuje výsledek“, „sbírají se údaje o lidech“), ne typ dokumentu, který by propustil skoro všechno – a jestli smí na web. Každý závažný nález pak dostane **nezávislého ověřovatele, který se ho snaží vyvrátit** – a ten má proti oponentovi jednu výhodu – nemá zadaný úhel, tedy ani tlak nějaký nález vrátit. Falešnou námitku tak zabije stroj, ne já. Zamítnuté námitky se zapisují, aby je příští oponentura nenašla znovu jako nové – a co jsme zavrhli už během psaní, dostanou oponenti rovnou v zadání, protože `docs/decisions.md` bývá v tu chvíli ještě prázdný. Ověřená fronta nálezů se ukládá na disk, takže přerušený průchod se dá dokončit později místo aby se celý běh platil znovu, a hotový běh po sobě nechá řádek v `docs/done.md` – včetně panelu úhlů, aby příští oponentura věděla, s čím se má srovnávat.
