...
- **Část znalostí v repu není.** `/compose` čte `~/Dev/context/compose/` a `~/Dev/archiv/`, doménové checklisty žijí v `~/Dev/context/` jako `web.md`, `admin.md`, `coding.md`, `text.md` a `worktrees.md`, k tomu knowledge base `analytics/` – odkazuje na ně `CLAUDE.md` a většinu z nich používá skill `/standards`, který bez nich neudělá nic. To je moje soukromé know-how a osobní archiv, takže je tu nenajdete – ty skilly jsou k mání jako kostra, ne jako hotová věc.
