...
Nejdřív zjistí, jestli to má kdo chtít: kdo ten problém má, jak ho dnes řeší a čím je doložené, že ho chce řešit jinak – a skončí to verdiktem o dvou hodnotách, doklady oddělenými od dojmů. Pak teprve zjistí, do jakého světa produkt vstupuje: kdo to už dělá, co to umí a za kolik, čím to lidé řeší dneska, když na to nemají nástroj, a na co si u stávajících řešení stěžují. Z toho vytřídí, co produkt musí umět, aby ho někdo vzal vážně, a čím se dá odlišit – ale jen tak, aby to šlo doložit. K tomu sepíše registr rizik, ve kterém má každá položka povinné pole *co se kvůli tomu v produktu změní*. Běží před zadáním, aby to, co najde, mohlo zadání ještě změnit.
