...
**Není to jen naše mezera.** Srovnání spec-driven frameworků ([arXiv 2606.04967](https://arxiv.org/pdf/2606.04967)) jmenuje šest věcí, které těmhle soustavám systematicky chybí; čtyři z nich máme zabrané (`/attack`, sledovací okno, doc-first řetěz, `FINDINGS.md`), *feedback integration* zůstává otevřená v `todo.md` a tahle sedmá – ověření poptávky před stavbou – se zavírá tímhle rozhodnutím.
