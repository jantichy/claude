...
- `~/Dev/context/text/text.md` – redakční standard pro psaní textů (stavba textu, obsah, zakázané obraty, stylistika, gramatika, text odkazu) – načti si ho vždy, když píšeš nebo edituješ souvislý text v češtině: článek, newsletter, dokumentaci, obsah webu
- `~/Dev/context/text/typography.md` – česká typografie (interpunkce a znaky, mezery, čísla, jednotky, datum a čas, výčty) – načti si ji vždy, když sázíš český text – tedy spolu s `text.md`, ale i tam, kde souvislý text nevzniká: slajd, popisek grafu, mikrocopy, dokumentaci
