...
- `~/Dev/context/business/business.md` – obchodní stránka práce: dnes fakturace (sazby, daňový režim, dohody s klienty, deník výjimek k obdobím) – načti si ji vždy, když vystavuješ faktury nebo řešíš, za co a kolik se účtuje; řídí ji skill `/invoicing`, který sám žádná čísla neobsahuje
