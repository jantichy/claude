...
- `~/Dev/context/analytics.md` – implementační webová analytika (revize měření, měřicí plán, dataLayer, GTM, GA4, consent a cookie lišty, reklamní systémy, e-commerce, testování) – načti si ho vždy, když reviduješ, nasazuješ nebo konfiguruješ webové měření; platí navíc k `web.md`
