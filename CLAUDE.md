...
- `~/Dev/context/analytics.md` – implementační webová analytika (principy, revize měření a katalog nálezů, měřicí architektura, datová vrstva, GTM, consent, GA4, reklamní systémy, platformy, nasazení, dokumentace pro klienta) – načti si ho vždy, když reviduješ, nasazuješ nebo konfiguruješ webové měření; platí navíc k `web.md`. Konkrétní GTM fragmenty per systém a feature jsou v `~/Dev/gtm/library/`
