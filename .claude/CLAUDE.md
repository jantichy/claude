...
Blok metadat je tady, a ne v kořenovém `CLAUDE.md`, jak velí `~/Dev/context/structure.md`. Ten je uživatelský a rozbaluje se do každé session v každém projektu — metadata tohohle repozitáře tam nepatří, mátla by v cizím projektu.
