...
`test` pokrývá čtyři vrstvy. **Počty testů se tu schválně neuvádějí** – rozejdou se s prvním doplněným scénářem a nikdo je nepřepočítává; kolik jich je, řekne `python3 -m unittest discover -s tests`:
