...
| brána | blokující kontrola | **Platební brána se nepřejmenovává nikdy** – ani v textu o ní, ani ve výtahu z konverzace. Náhrada míří výhradně na *automatickou kontrolu nástrojem, která práci zastaví*; kde je to jasné, stačí „kontrola“ |
| brána k datům | cesta k datům | jediná funkce, přes kterou aplikace sahá na vlastní databázi – otevře transakci a nastaví kontext izolace. Nepřidávej „bráně“ třetí význam |
