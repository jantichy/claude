...
Doménové checklisty (`~/Dev/claude/CODING.md`, `WEB.md`, `ADMIN.md`, `TEXT.md`, `WORKTREES.md`) se do projektu načítají `@import`em v jeho `CLAUDE.md` – tam, kde jsou pro jeho charakter relevantní.
