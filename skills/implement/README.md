...
>
> **Osa** [`/project`](../project/README.md) → [`/discovery`](../discovery/README.md) → [`/specify`](../specify/README.md) → `/architect` → [`/breakdown`](../breakdown/README.md) → **`/implement`** → [`/release`](../release/README.md)
>
