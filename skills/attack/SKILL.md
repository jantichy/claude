---
name: attack
description: Skill se použije, když uživatel zadá "/attack", "/attack branch" nebo "/attack full", anebo chce hotovou práci prověřit tak, že se ji někdo pokusí reálně rozbít – spustit aplikaci, sahat na ni mimo hlavní scénář, posílat nesmyslné vstupy, lámat stavy a hledat, co spadne. Na rozdíl od /review, který kód čte, tenhle skill ho spouští. Běží výhradně proti lokální instanci, nikdy proti produkci.
