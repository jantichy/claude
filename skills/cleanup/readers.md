...
**Do zadání doplň seznam odvolaných závěrů, má-li session nějaké.** Vytěžovací agent je vrací v sekci *Odvolané závěry* ([`agent.md`](agent.md), bod 8), takže ten seznam vzniká sám – ty ho z transcriptu nemáš odkud vzít – vypiš čtenáři konkrétní vysvětlení, která v nějaké chvíli byla zapsaná jako platná a později padla, s větou, že najde-li je někde tvrzené jako platné, je to nález. U session, která během dne několikrát obrátila závěr, je rozdíl mezi „hledej rozpory“ a „tyhle konkrétní věty jsou vyvrácené“ zásadní: doloženo 25. 9. 2026, kdy pět takových vět dalo pět nálezů, mimo jiné vyvrácenou řadu čísel v katalogu hypotéz. **Nejsou-li žádné, pole vynech** – prázdný seznam mate.
