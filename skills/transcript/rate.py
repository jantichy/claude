...
# Klíč "diarize" je druhý průchod (pyannote), ne přepis. Výchozí hodnota je
# střízlivý odhad, ne měření – po prvním běhu se přepíše skutečností.
DEFAULTS = {"turbo": 5.4, "large-v3": 1.67, "diarize": 8.0}
FALLBACK = 2.0
