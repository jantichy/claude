...
>
> **Kontroly** [`/oponent`](../oponent/README.md) · `/consolidate` · **`/review`** · [`/consistency`](../consistency/README.md) · [`/attack`](../attack/README.md) · [`/cleanup`](../cleanup/README.md) – stojí v mezerách mezi kroky osy, některé z nich ve víc mezerách
>
