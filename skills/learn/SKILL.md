...
Skill se **nespouští s přepínači**, ale s volným popisem, ze kterého vyčte zdroj i cíl. `argument-hint` proto jmenuje `[zdroj] [cíl]` jako **dvě věci, které v tom popisu mají zaznít**, ne jako dvě poziční hodnoty:
